    ...
    <table cellpadding="2" cellspacing="5" border="0">
        <tr>
            <td align="left" valign="middle" width="20%">
                <img src="Assets/logo.png" alt="Abhi's logo" border="0">
            </td>
...
function generateName($gender) {
    ...
    $nameFile = ($gender == 'male') ? 'Assets/male.txt' : 'Assets/female.txt';
...
function generateLastName() {
    ...
    $lastNames = file('Assets/last_names.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
...
function generateAddress() {
    ...
    $addresses = file('Assets/addresses.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
...
function generateQualification() {
    ...
    $qualifications = file('Assets/qualifications.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
